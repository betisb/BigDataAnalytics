...
DataDirectory = "C:/Users/Betis/PycharmProjects/Big_Data/src/user_by_month/"
...
pyfile = "C:\\Users\\Betis\\PycharmProjects\\Big_Data\\scripts\\mapping.py"
...
for i in range(len(pathAscendSize)):
    ...
    cmdChild = [f"python", f"{pyfile}", f"{batchFiles}"]
